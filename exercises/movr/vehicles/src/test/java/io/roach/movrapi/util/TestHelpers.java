...
public class TestHelpers {
    ...
    public static Vehicle copy(Vehicle originalVehicle) {
        Vehicle vehicleCopy = new Vehicle();
        vehicleCopy.setId(originalVehicle.getId());
        vehicleCopy.setSerialNumber(originalVehicle.getSerialNumber());
        vehicleCopy.setBattery(originalVehicle.getBattery());
        vehicleCopy.setLastRideStart(originalVehicle.getLastRideStart());
        vehicleCopy.setLastRideEnd(originalVehicle.getLastRideEnd());
        vehicleCopy.setVehicleInfo(originalVehicle.getVehicleInfo());
        vehicleCopy.setLocationHistoryList(originalVehicle.getLocationHistoryList());
