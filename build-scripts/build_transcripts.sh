...
function help {
    ...
    echo ""
    echo "USAGE: build_transcripts.sh <source> <destination>"
    echo ""
...
do
    ...
    # Delete everything outside of the /script...script/ tags.
    sed -e '1,/\/script/d' -e '/script\//,/\/script/d' -e '/script\//,$d' $FILE > $DESTINATION_FILE
done